...
- **Epic 15 (Operator transport/session UX)** — в работе; `TASK-022..024` закрыты, следующий slice — `TASK-025` про safe file exchange для active project/worktree

## Next

- `TASK-025` — safe file exchange for project roots поверх active context/worktree binding
- После `TASK-025`: открыть `TASK-026` для transport plugin/setup checks
