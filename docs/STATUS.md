...
- **Epic 15 (Operator transport/session UX)** — в работе; `TASK-022` и `TASK-023` закрыты, следующий slice — `TASK-024` про operator session continuity/resume handles

## Next

- `TASK-024` — operator session memory and resume handles поверх нового directive/context contract
- После `TASK-024`: открыть `TASK-025..026` для file-exchange/transport plugin слоя
