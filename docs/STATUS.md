...
- **Epic 13 (Live agent feedback loop)** — активен; `TASK-012`, `TASK-013` и `TASK-014` закрыты, следующий узкий slice: `live status feed` поверх `events.jsonl` / `event_snapshot.json`
