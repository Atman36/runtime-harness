...
- **Epic 13 (Live agent feedback loop)** — активен; `TASK-012`, `TASK-013`, `TASK-014` и `TASK-015` закрыты, следующий узкий slice: `live status feed` поверх `events.jsonl` / `event_snapshot.json`
